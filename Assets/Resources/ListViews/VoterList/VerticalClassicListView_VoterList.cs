...
namespace frame8.ScrollRectItemsAdapter.Classic.Examples
{
	...
	public class VerticalClassicListView_VoterList : ClassicSRIA<VoterList_SimpleExpandableClientViewsHolder>, CExpandCollapseOnClick.ISizeChangesHandler
	{
		...
		public bool isTruthList;

		LayoutElement _PrefabLayoutElement;
		// Used to quickly retrieve the views holder given the gameobject
		Dictionary<RectTransform, VoterList_SimpleExpandableClientViewsHolder> _MapRootToViewsHolder = new Dictionary<RectTransform, VoterList_SimpleExpandableClientViewsHolder>();


		// DEMO UI REPLACEMENTS
		bool freezeContentEndEdge_isOn = false;
		...
		protected override void Awake()
		{
			...
			//Debug.Log("IS TRUTH LIST: " + isTruthList);

			//// DEBUG
			//playerList = new List<Player>();
			//playerList.Add(new Player("HI"));
			//playerList.Add(new Player("HIYA"));
		...
		protected override VoterList_SimpleExpandableClientViewsHolder CreateViewsHolder(int itemIndex)
		{
			var instance = new VoterList_SimpleExpandableClientViewsHolder();
		...
		protected override void UpdateViewsHolder(VoterList_SimpleExpandableClientViewsHolder vh) { vh.UpdateViews(Data[vh.ItemIndex]); }
		#endregion
